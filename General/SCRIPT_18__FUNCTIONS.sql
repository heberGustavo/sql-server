...
/******* FUNCTION WITH RETURN OF TABLE ********/
CREATE FUNCTION FN_LIVRO_AUTOR_ITEMS_TABLE
(
	@PRECO_LIVRO MONEY
)
...
AS 
BEGIN 
	INSERT @TB_RESULT (NOME_LIVRO, NOME_AUTOR, NOME_EDITORA, PRECO_LIVRO)
	SELECT L.LVR_NOME, A.ATR_NOME, E.EDT_NOME, L.LVR_PRECO
	FROM TB_LIVRO L
	INNER JOIN TB_AUTOR A ON A.ATR_ID = L.ATR_ID
...
SELECT * FROM dbo.FN_LIVRO_AUTOR_ITEMS_TABLE(60)
